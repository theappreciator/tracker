...
var usingFlyRegion = process.env.FLY_REGION ?? "unknown" // e.g "lhr"
...
// This is if we multiple connect strings for multiple regions, for the code to smartly pick on
 ...
 * @returns {String}
 */
/* comment out because don't need region checking
