...
import { Box, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Divider, ListSubheader, Typography, IconButton, Skeleton } from '@mui/material';
              ...
              return (
                <>
                  <nav aria-label={`list for ${d.date}`}>
                    ...
                    {!showSkeleton && (
                      <ListSubheader sx={{ backgroundColor: "#eee", borderRadius: "0.5rem", paddingTop: "0.4rem", paddingBottom: "0.4rem" }}>
                        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "flex-start" }}>
                            <Typography sx={{ flexGrow: 1, fontWeight: 700, color:'#333'}}>
